...
;; Before this version of mini-scheme will work, you need to do the
;; following:
;;
...
;;
;; Note that of these, (1)-(3) are also neeed for micro-scheme.  And even
;; without (4), you would have a somewhat working mini-scheme, just limited
;; to + and -.
